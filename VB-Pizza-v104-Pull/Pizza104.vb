Public Class Pizza104
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        students(0).deliveryDate = "28/10/21"
    ...
    Private Sub btnAddStud_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        ...
        students(studentCount).deliveryDate = dteDelivery.Text & "1" & cboHour.Text & ":" & cboMinute.Text
        studentCount += 1
    ...
    Private Sub txtQuantity_SelectedIndexChanged(sender As Object, e As EventArgs) Handles txtQuantity.SelectedIndexChanged
